...
完整文档：[checkpoint-system.md](checkpoint-system.md)

## Examples

- [gear-with-checkpoints.py](gear-with-checkpoints.py) - 正确的齿轮（带验证）
- [gear-wrong-with-checkpoints.py](gear-wrong-with-checkpoints.py) - 错误检测演示
